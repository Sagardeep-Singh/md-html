...
from .views import (CsrfToken, DocumentDetailView, DocumentView, UserProfileView,
                    IsAuthenticated, LoginView, LogoutView, SignupView,
                    UserDetail, UserList, api_root, mdToHtml, htmlToMd)
...
urlpatterns = [
    ...
    path('html', mdToHtml, name='md-to-html'),
    path('md', htmlToMd, name='html-to-md'),
]
